...
/**
app.controller('editMultipleProductCtrl', ['$scope', '$http', '$cookies', '$cookieStore', '$filter', '$routeParams', function ($scope, $http, $cookies, $cookieStore, $filter, $routeParams) {
    ...
    angular.element(document).ready(function () {
        ...
        $http.get("http://localhost/flair/app/api/v1/products/" + c_id + "/multi/" + v_id).success(function (response) {
console.log(response);
            if (response.result) {
        ...
        $http.get("http://localhost/flair/app/api/v1/categories/" + c_id).success(function (response) {
            console.log(response);
            if (response.result) {
    ...
    $scope.updateMultipleProduct = function () {
        var bit = true,
            ui = u_id,
            params = [];
        
        angular.forEach($scope.listproducts, function (item) {
            
            var product_id = item.product_id,
                name = angular.element("#name_" + product_id).val(),
                code = angular.element("#code_" + product_id).val(),
                category_id = angular.element("#category_id_" + product_id).val(),
                //description = angular.element("#description_" + product_id).val(),
                price = angular.element("#price_" + product_id).val(),
                qty = angular.element("#qty_" + product_id).val(),
        ...
        $http.put("http://localhost/flair/app/api/v1/products/multi", params).success(function (response) {
        console.log(response);
            ...
            if (response.result) {
                var ui = u_id,
                    params = {
                        user_id: ui,
                        activity: "Update Multiple Product Details"
                    };
...
console.log(response);
        ...
        if (bit) {
            $scope.result_msg = "Product details successfully updated.";
            $scope.success = true;
            $scope.failed = false;
