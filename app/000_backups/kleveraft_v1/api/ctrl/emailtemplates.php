    ...
    if($template == 'forgotpassword'){
        ...
        if($qresult){
            ...
            if(mysqli_num_rows($qresult)!=0){
                ...
                $body .= '<p>Dear ' . $firstname . ' ' . $lastname . ',</p><br/>';
                $body .= '<p>Congratulations! You now have access to the Kleveraft\'s Business Management App.</p><br/>';
                $body .= '<p>Just click this <a href="https://www.kleveraft.com/app">link</a> and fill up your log in details to access your acount.</p><br/>';
            }
        ...
        if($qresult){
            ...
            if(mysqli_num_rows($qresult)!=0){
                ...
                $body .= '<p>Dear ' . $firstname . ' ' . $lastname . ',</p><br/>';
                $body .= '<p>Congratulations! You now have access to the Kleveraft\'s Business Management App. See below log in details:<br/></p>';
